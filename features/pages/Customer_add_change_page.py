...
class AddressChangeForm(PageBase):

    def change_custandbilling_address(self, address):
        self.enter_text_advanced(address, billingLocator.ADDRESS_FORM, billingLocator.TXT_POSTAL_CODE) 
        sleep(5)
        pg.press('down''down')
        sleep(5)
